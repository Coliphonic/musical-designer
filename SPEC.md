...
| Book export — EPUB + print PDF, front/back matter, themes, trim sizes (see below; Manuscript-format PDF for agent submission stays as-is) | 🔶 Phase 0 done (`state.book` data model + Page-setup drawer entry point, 2026-07-09) — see `BOOK-FORMATTING-PLAN.md` |
