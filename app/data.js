...
const SHOWS = {
  ...
  wicked: {
    ...
    cards: [
      ...
      { lane: '1', type: 'beat', title: 'A cruel gift, a kind turn', note: 'Galinda gifts Elphaba an ugly hat as a prank. When Elphaba wears it bravely onto the dance floor, Galinda\'s conscience turns — and a real friendship begins.', min: 1.5 },
      ...
      { lane: '2A', type: 'beat', title: 'The test, and the betrayal', note: "The Wizard has Elphaba enchant his monkeys — then reveals he means to cage them as spies. She realizes he is the source of Oz's cruelty, not its cure, and runs.", min: 1.5 },
      ...
      { lane: '2B', type: 'beat', title: 'Two different paths', note: 'Branded "wicked" and on the run, Elphaba is now Oz\'s scapegoat — while Glinda has become its beloved public face, engaged to Fiyero.', min: 1.5 },
      ...
      { lane: '2B', type: 'beat', title: 'Nessarose and Boq', note: "Elphaba's spell to help her heartbroken sister backfires, costing Boq his heart — the first step toward the Tin Man.", min: 1 },
      { lane: '2B', type: 'scene', title: "The Wizard's Chamber" },
      { lane: '2B', type: 'song', title: 'Wonderful', fn: 'charm', voicing: 'The Wizard, Elphaba', min: 3 },
      { lane: '2B', type: 'beat', title: 'Almost persuaded', note: 'The Wizard nearly wins Elphaba back — until she learns Dr. Dillamond has been silenced for good. She refuses him for the last time.', min: 1 },
      ...
      { lane: '2B', type: 'beat', title: 'Fiyero captured', note: "Fiyero chooses Elphaba and is seized by the Wizard's guards. Word reaches her that he may be killed.", min: 1 },
      ...
      { lane: '3', type: 'beat', title: 'The truth behind the curtain', note: "Elphaba stages her own melting to escape with Fiyero; Glinda exposes the Wizard and banishes Morrible, and keeps her friend's secret. Each has changed the other for good.", min: 1.5 },
  ...
  legallyblonde: {
    ...
    cards: [
      ...
      { lane: '1', type: 'beat', title: 'In over her head', note: 'Professor Callahan humiliates an unprepared Elle and throws her out of class. Harvard is nothing like home.', min: 1 },
      ...
      { lane: '2A', type: 'beat', title: 'Buckling down', note: 'Emmett, who earned everything the hard way, pushes Elle to actually study — and she excels, landing a coveted internship spot.', min: 1 },
      ...
      { lane: '2B', type: 'beat', title: 'The fitness queen on trial', note: 'Elle\'s sorority idol Brooke Wyndham is accused of murdering her husband. Elle joins the defense and wins Brooke\'s trust through their Delta Nu bond.', min: 1.5 },
      ...
      { lane: '2B', type: 'beat', title: 'Helping Paulette', note: 'Elle gives Emmett a makeover and coaches Paulette to find her confidence — and the courage to land the UPS man.', min: 1 },
      ...
      { lane: '3', type: 'beat', title: 'Callahan crosses the line', note: 'After Elle cracks a key witness, Callahan makes a pass at her. Disillusioned, she nearly quits law for good.', min: 1.5 },
      { lane: '3', type: 'song', title: 'Legally Blonde', fn: 'ballad', voicing: 'Emmett, Elle', min: 3 },
      { lane: '3', type: 'beat', title: 'Rallied back', note: 'Vivienne, disgusted by Callahan, joins Emmett in convincing Elle to take over the case herself.', min: 1 },
      { lane: '3', type: 'song', title: 'Legally Blonde Remix', fn: 'production', voicing: 'Vivienne, Enid, Paulette, Elle, Company', min: 4 },
      { lane: '3', type: 'beat', title: 'Winning on her own terms', note: 'Elle cracks the case using knowledge no one expected her to have — the rules of a perm — exposing the false alibi and freeing Brooke.', min: 1 },
  ...
  littlemermaid: {
    ...
    cards: [
      ...
      { lane: '1', type: 'beat', title: 'Two worlds', note: "Sailors sing of the merfolk below; on deck, Prince Eric yearns for something the land can't give him. A storm is gathering.", min: 1 },
      ...
      { lane: '1', type: 'beat', title: "Ursula's exile", note: "Banished from the palace, the sea witch Ursula plots to reclaim her power through Triton's headstrong youngest.", min: 1 },
      ...
      { lane: '2A', type: 'beat', title: 'Ariel saves Eric', note: "A storm wrecks Eric's ship; Ariel pulls the drowning prince to shore and, unseen, sings to him before fleeing. He wakes haunted by her voice.", min: 1.5 },
      ...
      { lane: '2A', type: 'beat', title: "A father's fury", note: "Triton discovers Ariel's obsession with humans and destroys her treasured collection; heartbroken, she's easy prey for the eels.", min: 1 },
      ...
      { lane: '2B', type: 'beat', title: 'A voiceless girl on land', note: "Washed ashore with new legs and no voice, Ariel is found by Eric, who senses something familiar he can't place.", min: 1 },
      ...
      { lane: '2B', type: 'beat', title: 'The clock is ticking', note: "Eric and Ariel grow close, but the three-day deadline looms — and Ursula schemes to make sure the kiss never lands.", min: 1 },
      ...
      { lane: '3', type: 'beat', title: 'So close', note: "Sebastian conjures the perfect moment — until the eels capsize the boat. Ursula resolves to take Eric herself, disguised and wearing Ariel's stolen voice.", min: 1 },
      { lane: '3', type: 'song', title: 'If Only (Quartet)', fn: 'ballad', voicing: 'Ariel, Eric, Triton, Sebastian', min: 3 },
      { lane: '3', type: 'beat', title: "The witch's gambit", note: 'As the maiden "Vanessa," Ursula bewitches Eric toward marriage. Ariel\'s deadline runs out as Scuttle races to expose the fraud.', min: 1.5 },
      { lane: '3', type: 'song', title: 'Poor Unfortunate Souls (Reprise)', fn: 'reprise', voicing: 'Ursula', min: 1.5 },
      { lane: '3', type: 'beat', title: "Triton's sacrifice", note: 'To free Ariel, Triton trades his crown and his life to Ursula, who seizes his power — and Eric and Ariel together destroy the sea witch.', min: 1.5 },
