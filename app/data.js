...
const TEMPLATES = [
  ...
  // The Story Board (2026-09-24): Save the Cat's board for a two-act book
  // musical, 40 book beats around 19 songs. NOT cut from the song corpus — its
  // basis is 20 beat sheets built from the shows' published synopses
  // (corpus/story-beats/, write-up in MUSICAL-BEAT-BOARD.md), so its basis line
  // cites story sources, not a corpus n=. Lanes follow Snyder's act boundaries:
  // Break into Two opens 2A, Break into Three opens 3 — which is why the rows
  // are 13/18/18/10, not even tens (the musical's Act Three is short).
  // Song seats ship WORKING TITLES ("Candy dish", "Tent pole") that carry into
  // a created show; every other shape ships title: ''. Beat cards carry the
  // research as Beatline prompts, like the ten-minute shapes.
  {
    id: 'full-board',
    label: 'Story Board',
    sub: 'Save the Cat’s board for a book musical: 40 book beats around 19 songs, measured on twenty real shows.',
    mode: 'full',
    basis: 'Story sources (n=20) · beat sheets from published synopses · Catalyst 10% · Break into Two 23% · Midpoint 47% · Break into Three 84–87%',
    cards: [
      // ── Lane 1 · Act One: the world, the Catalyst, the Debate (0–21%) ─────────
      { act: '1',  type: 'song', title: 'Opening Image', fn: 'opening', voicing: 'Company', min: 4.5 },
      { act: '1',  type: 'beat', title: 'Ordinary world', beatFn: 'Set-Up', min: 1.5,
        note: 'The hero’s everyday life. Keep it lean: the opening has already sung the world.' },
      { act: '1',  type: 'song', title: 'Theme Stated', fn: 'establishing', voicing: 'Company', min: 3 },
      { act: '1',  type: 'beat', title: 'The flaw on display', beatFn: 'Set-Up', min: 1.5,
        note: 'Show what needs fixing in the hero, before anyone names it.' },
      { act: '1',  type: 'beat', title: 'What’s at stake', beatFn: 'Set-Up', min: 1.5,
        note: 'Home, and the people who will be left behind.' },
      { act: '1',  type: 'beat', title: 'The opposing force', beatFn: 'Set-Up', min: 1.5,
        note: 'Introduce whoever or whatever stands against the want.' },
      { act: '1',  type: 'beat', title: 'Catalyst', beatFn: 'Catalyst', min: 1.5,
        note: 'Something happens to the hero, in dialogue. Spoken in 14 of 20 shows. Higgins wagers he can pass Eliza off; an eclipse brings Seymour the plant.' },
      { act: '1',  type: 'beat', title: 'Immediate fallout', beatFn: 'Catalyst', min: 1.5,
        note: 'The first consequence lands, and it makes the want urgent.' },
      { act: '1',  type: 'song', title: 'The want', fn: 'iwant', voicing: 'Solo', min: 3 },
      { act: '1',  type: 'beat', title: 'Reluctance', beatFn: 'Debate', min: 1.5,
        note: 'The I Want answered the Catalyst (it follows it in 11 of 15 shows); now the world answers the I Want.' },
      { act: '1',  type: 'beat', title: 'Stakes named aloud', beatFn: 'Debate', min: 1.5,
        note: 'A mentor, rival or the ensemble pushes; someone says the cost out loud.' },
      { act: '1',  type: 'song', title: 'Debate', fn: 'comedy', voicing: '', min: 3 },
      { act: '1',  type: 'beat', title: 'Stasis = death', beatFn: 'Debate', min: 1.5,
        note: 'Staying becomes impossible. Often a loss: Warner dumps Elle.' },
      // ── Lane 2A · Act Two begins: Break into Two to the curtain (22–49%) ──────
      { act: '2A', type: 'beat', title: 'Break into Two', beatFn: 'Break into Two', min: 1.5,
        note: 'The hero chooses the new world, around 23%. Half the sources sing it (Ya Got Trouble, Grow for Me), half speak it (Eliza turns up at Higgins’s door). Make this a song if the choice needs music.' },
      { act: '2A', type: 'beat', title: 'Arrival', beatFn: 'Break into Two', min: 1.5,
        note: 'First contact with the new world and its rules. The ramp for the Noise.' },
      { act: '2A', type: 'song', title: 'The Noise', fn: 'production', voicing: 'Company', min: 3.5 },
      { act: '2A', type: 'beat', title: 'B Story', beatFn: 'B Story', min: 1.5,
        note: 'Meet the relationship that carries the theme, here in the new world. It arrives after the Break into Two in 13 of 20 shows, in every era.' },
      { act: '2A', type: 'beat', title: 'Love interest emerges', beatFn: 'Fun and Games', min: 1.5,
        note: 'Often a product of the new world: Fiyero at Shiz, Emmett at Harvard.' },
      { act: '2A', type: 'song', title: 'Meet-spark', fn: 'love', voicing: 'Duet', min: 3 },
      { act: '2A', type: 'beat', title: 'The premise at work', beatFn: 'Fun and Games', min: 1.5,
        note: 'The promise of the premise: the scene the poster sells.' },
      { act: '2A', type: 'beat', title: 'The second couple forms', beatFn: 'Fun and Games', min: 1.5,
        note: 'Or a comic ally arrives. Its function is relief, and it has to land somewhere.' },
      { act: '2A', type: 'song', title: 'Comic ally', fn: 'comedy', voicing: '', min: 3 },
      { act: '2A', type: 'beat', title: 'Complication seeded', beatFn: 'Fun and Games', min: 1.5,
        note: 'Plant the crack that widens in Act Two.' },
      { act: '2A', type: 'song', title: 'Tent pole', fn: 'production', voicing: 'Company', min: 3.5 },
      { act: '2A', type: 'beat', title: 'Riding the high', beatFn: 'Fun and Games', min: 1.5,
        note: 'Everything is working. Let the audience enjoy it for one scene.' },
      { act: '2A', type: 'beat', title: 'The turn', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'Pressure arrives before the curtain, as it does in 14 of 20 shows.' },
      { act: '2A', type: 'beat', title: 'The cost becomes visible', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The win has a price, and someone sees it.' },
      { act: '2A', type: 'song', title: 'Dark turn', fn: 'villain', voicing: '', min: 3 },
      { act: '2A', type: 'beat', title: 'The trap springs', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The antagonist’s move lands.' },
      { act: '2A', type: 'beat', title: 'Pre-curtain', beatFn: 'Midpoint', min: 1.5,
        note: 'A choice forced. When the Midpoint isn’t the curtain it lands here (One Hand, One Heart).' },
      { act: '2A', type: 'song', title: 'Midpoint', fn: 'finale', voicing: 'Company', min: 5 },
      // ── Lane 2B · Bad Guys Close In, All Is Lost, the Dark Night (to ~82%) ────
      { act: '2B', type: 'song', title: 'Candy dish', fn: 'production', voicing: 'Company', min: 3.5 },
      { act: '2B', type: 'beat', title: 'The bill arrives', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The Act One choice starts costing. If the curtain was the bottom (5 of 20), open in the Dark Night instead.' },
      { act: '2B', type: 'beat', title: 'The lie compounds', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The deal or deception has to grow to survive.' },
      { act: '2B', type: 'song', title: 'Under pressure', fn: 'reprise', voicing: '', min: 2 },
      { act: '2B', type: 'beat', title: 'An ally lost', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'Lost or betrayed. Reprises do the closing in: 10 of 18 land in this stretch.' },
      { act: '2B', type: 'beat', title: 'The antagonist presses', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'External pressure and internal doubt, in the same scene.' },
      { act: '2B', type: 'song', title: 'Comic ally', fn: 'comedy', voicing: 'Duet', min: 3 },
      { act: '2B', type: 'beat', title: 'Another door closes', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'An option dies.' },
      { act: '2B', type: 'song', title: 'Love under strain', fn: 'love', voicing: 'Duet', min: 3 },
      { act: '2B', type: 'beat', title: 'The last good option dies', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The noose tightens.' },
      { act: '2B', type: 'song', title: 'The antagonist’s move', fn: 'drive', voicing: 'Company', min: 3 },
      { act: '2B', type: 'beat', title: 'Exposure looms', beatFn: 'Bad Guys Close In', min: 1.5,
        note: 'The secret, the lie or the debt is one scene from coming out.' },
      { act: '2B', type: 'beat', title: 'All Is Lost', beatFn: 'All Is Lost', min: 1.5,
        note: 'The bottom, as an event, around 75%. Spoken in 15 of 20 shows. Otherwise an exposure or a break: Evan confesses to the Murphys.' },
      { act: '2B', type: 'beat', title: 'Whiff of death', beatFn: 'All Is Lost', min: 1.5,
        note: 'Full fallout. A literal death in 7 of 20: the Giant kills the Baker’s Wife, Johnny dies.' },
      { act: '2B', type: 'song', title: 'Dark Night', fn: 'ballad', voicing: 'Solo', min: 3.5 },
      { act: '2B', type: 'beat', title: 'Alone with it', beatFn: 'Dark Night', min: 1.5,
        note: 'Want stripped away so need surfaces.' },
      { act: '2B', type: 'beat', title: 'The seed of the answer', beatFn: 'Dark Night', min: 1.5,
        note: 'A memory, a line, an object from Act One that means something new now.' },
      { act: '2B', type: 'beat', title: 'Someone comes back', beatFn: 'Dark Night', min: 1.5,
        note: 'The partner, parent, mentor or friend who brings the answer. Close kin to the seed of the answer: in 16 of 20 shows the Break into Three turns on a relationship, and this is where it walks back in.' },
      // ── Lane 3 · Act Three: Break into Three at ~83%, the finale climb ────────
      { act: '3',  type: 'beat', title: 'The fix addresses the need', beatFn: 'Break into Three', min: 1.5,
        note: 'The answer becomes a plan, around 85%: it changes because the hero has.' },
      { act: '3',  type: 'song', title: 'Break into Three', fn: 'ballad', voicing: 'Duet', min: 3 },
      { act: '3',  type: 'beat', title: 'Gathering the Team', beatFn: 'Finale', min: 1.5,
        note: 'The plan and the people, then everyone who matters in one place.' },
      { act: '3',  type: 'beat', title: 'The Main Event', beatFn: 'Finale', min: 2,
        note: 'The confrontation the premise promised, onstage, never reported. Often sung (Sit Down, You’re Rockin’ the Boat); make it a song if yours is.' },
      { act: '3',  type: 'song', title: 'Eleven o’clock', fn: 'eleven', voicing: 'Solo', min: 4.5 },
      { act: '3',  type: 'beat', title: 'High Tower Surprise', beatFn: 'Finale', min: 1.5,
        note: 'The twist inside the confrontation: Glinda learns the Wizard fathered Elphaba.' },
      { act: '3',  type: 'beat', title: 'Dig Deep Down', beatFn: 'Finale', min: 1.5,
        note: 'The need applied, when the plan alone fails.' },
      { act: '3',  type: 'beat', title: 'The verdict', beatFn: 'Finale', min: 1.5,
        note: 'The plot resolves; want against need is settled.' },
      { act: '3',  type: 'beat', title: 'The subplot resolves', beatFn: 'Finale', min: 1.5,
        note: 'The second couple or ally gets its button.' },
      { act: '3',  type: 'song', title: 'Final Image', fn: 'finaleultimo', voicing: 'Company', min: 3 },
    ],
  },
  {
    id: 'full-sungthrough',
...
const NOVELS = {
  ...
  holes: {
    title: 'Holes', year: 1998, form: 'novel',
    teaches: 'Braided timelines converging — three stories set 150 years apart that turn out to be one; and the tightest setup/payoff economy in modern fiction, where a pig carried uphill, a jar of spiced peaches, a rowboat and an onion field all pay off a century later',
    characters: {
      'STANLEY YELNATS IV': { desc: 'Fourteen, overweight, bullied, and wrongly convicted of stealing a pair of donated sneakers. Nicknamed Caveman at camp. The protagonist of the present-day strand, and — though neither he nor the reader knows it for forty chapters — the one person who can settle a debt incurred in Latvia five generations before he was born.' },
      'ZERO / HECTOR ZERONI': { desc: 'The smallest and youngest digger, silent, assumed stupid, and in fact the fastest hole-digger in Group D. Illiterate and homeless before camp. Madame Zeroni\'s great-great-great-grandson — the second half of the convergence, hidden in plain sight behind a nickname that means nothing.' },
      'THE WARDEN (LOUISE WALKER)': { desc: 'Soft-spoken, red-haired, and genuinely dangerous — she keeps a nail polish cut with rattlesnake venom. Granddaughter of Trout Walker, running the camp as a hundred-boy excavation crew for a treasure her family has hunted for three generations. The antagonist of the present strand and the descendant of the antagonist of the past one.' },
      'MR SIR': { desc: 'The counselor who runs the water truck and eats sunflower seeds by the sack, having quit smoking. Petty, punitive, and cowardly the moment the lizards appear — the daily face of the camp\'s authority.' },
      'MR PENDANSKI': { desc: 'The counselor who uses the boys\' real names and encourages them to plan their futures, which reads as kindness until you notice he saves his contempt for Zero. Provokes the attack that breaks the plot open.' },
      'X-RAY, ARMPIT, SQUID, MAGNET, ZIGZAG': { desc: 'Group D — the tent Stanley is assigned to, ruled by X-Ray, who is neither the biggest nor the toughest but controls the water line and the finds. The nickname economy is the camp\'s whole social system, and it is what conceals Hector Zeroni inside "Zero."' },
      'KATHERINE BARLOW / KISSIN\' KATE': { desc: 'The schoolteacher of Green Lake, Texas, famous for her spiced peaches — and, after the town murders the man she loved, the outlaw who robs and kisses her victims. The 110-years-ago strand belongs to her, and every object she leaves behind (a lipstick tube, jars of preserves, a stolen suitcase) becomes a present-day plot device.' },
      'SAM THE ONION MAN': { desc: 'The Black onion farmer who rows across Green Lake with his donkey Mary Lou, sells onions as a cure for everything, and can fix anything. Murdered by a mob for kissing Katherine Barlow. It has not rained on Green Lake since — the drought is the crime, still unresolved a century later.' },
      'CHARLES "TROUT" WALKER': { desc: 'The richest man in Green Lake, rejected by Katherine, and the killer of Sam. Loses the lake, the fortune and everything else; his granddaughter inherits the hole he never finished digging.' },
      'ELYA YELNATS': { desc: 'A fifteen-year-old in Latvia who wanted a girl he did not need and took a bargain he did not keep. Great-great-grandfather to Stanley, and the origin of the family\'s bad luck — the boy whose broken promise is the book\'s first cause.' },
      'MADAME ZERONI': { desc: 'The one-footed Egyptian fortune teller who gives Elya a piglet on terms: carry it up the mountain to drink each day and sing to it, then carry her up at the end. He forgets. She curses him and his descendants — and her own descendant is the boy Stanley will eventually carry up a mountain.' },
      'STANLEY YELNATS I': { desc: 'The great-grandfather who made a fortune, was robbed by Kissin\' Kate Barlow, and survived the desert by finding refuge on God\'s Thumb. Both halves of his story become instructions the present-day plot follows exactly.' },
    },
    titlePage: {
      subtitle: 'A Novel',
      authors: 'By Louis Sachar · First published 20 August 1998 by Farrar, Straus and Giroux · Newbery Medal and National Book Award',
      settings: ['Camp Green Lake, Texas — a dry lakebed, present day', 'Green Lake, Texas — a green town with water, 110 years earlier', 'A village in Latvia, roughly 150 years earlier', 'Three timelines, told in alternation, that turn out to be one story'],
      productionNotes: 'Reference study object — structural scaffold only; published 1998, so no text is reproduced. The shelf\'s braided-timeline exemplar, and its setup/payoff masterclass. Read it for two things. First, the braid: the past strands are dropped in as short chapters between digging days, presented as folklore and backstory, and each one is quietly loading a gun the present strand will fire — the reader assembles the connection several chapters before Stanley does. Second, the economy: nearly every object planted in one timeline is spent in another. A piglet carried up a mountain becomes a boy carried up a mountain; Sam\'s onion field becomes lizard repellent; Kate Barlow\'s spiced peaches become the food that keeps two runaways alive a century later; her stolen suitcase carries the name of the boy who digs it up. Compare with Gatsby on the shelf — the same ~47,000 words, one timeline versus three.',
    },
    cards: [
      // Density rule: discrete-dramatic-unit level. 80 beats across ~47,000
      // words (~590 words/beat) — the same grain as gatsby, which is the same
      // length. 50 chapters, but they are very short (~940 words), so scene
      // cards group by MOVEMENT per the pride precedent.
      //
      // Scene cards here do extra work: each names its TIMELINE, so the braid
      // is legible on the board at a glance. Reading the spine labels down the
      // page gives you the interleaving pattern — present, present, Latvia,
      // present, Green Lake 1888, present — which is the thing this book is on
      // the shelf to teach.
      //
      // Part → lane mapping (~47k words): Sachar's own three parts are lopsided
      // (Part One = ch. 1–28, Part Two = ch. 29–49, Part Three = ch. 50), so
      // the lanes cut inside them. Lane 1 = ch. 1–13 (arrival, the rules, the
      // curse, the find, ~12k); 2A = ch. 14–28 (the Warden, the reading
      // lessons, and the 1888 strand delivered in one block, ~13k); 2B = ch.
      // 29–42 OPENS on Zero running — the break that turns a prison story into
      // a survival story — through Big Thumb and the confession (~13k); 3 =
      // ch. 43–50 (the last hole, the lizards, the payoffs, the rain, ~9k).

      // ===== LANE 1 — CHAPTERS 1–6 · CAMP GREEN LAKE (present) =====
      { lane: '1', type: 'scene', title: 'Chapters 1–6 · Camp Green Lake — Present Day', words: 5100 },
      { lane: '1', type: 'beat', beatFn: 'Hook (the joke that is a threat)', title: 'There is no lake at Camp Green Lake', note: 'The book opens on the name and immediately withdraws it: no lake, no green, no shade but two trees and a hammock, and that hammock belongs to the Warden. A title that is a lie about the setting, and the first hint that this place is the wreckage of something that used to be true.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Establishing (the rule)', title: 'One hole a day, five feet every way', note: 'The camp\'s single law, stated flatly: each boy digs one hole, five feet deep and five feet across, measured by the shovel, and the day ends when the hole does. A premise a child can hold in one hand — and a structure, since the novel can now mark time by holes instead of dates.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'The stated reason (false)', title: 'It builds character', note: 'The counselors explain that digging makes a bad boy into a good boy. The reader is handed the official purpose in chapter one and will spend twenty-seven chapters watching it curdle — the holes have a reason, and it has nothing to do with character.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Inciting incident', title: 'A pair of sneakers falls out of the sky', note: 'Stanley is walking home when a pair of shoes drops from an overpass and hits him; he is arrested carrying them, and they turn out to be Clyde Livingston\'s, donated to a shelter auction. The absurdity is the point — the wrongful conviction is genuinely inexplicable until chapter 42 explains it from the other end.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'False choice', title: 'Camp, or jail', note: 'Offered the choice, Stanley picks camp — his family has never been able to afford one. A joke and a characterization: the boy is an optimist in a book whose whole premise is that his family\'s optimism is unwarranted.', min: 0.4 },
      { lane: '1', type: 'beat', beatFn: 'PLANT (the curse) — first cause', title: 'The great-great-grandfather who broke a promise', note: 'The Yelnats explanation for everything: an ancestor who stole a pig, or failed to keep a bargain about one, and cursed the line. The family recites it as a joke whenever anything goes wrong. Presented as comic folklore in chapter three; it is the actual mechanism of the plot, and the book has just told the reader so while sounding like it was kidding.', min: 0.6 },
      { lane: '1', type: 'beat', beatFn: 'Introduction (authority)', title: 'Mr Sir and the sunflower seeds', note: 'The counselor who controls the water truck, quit smoking, and eats seeds by the sack. Petty tyranny with an appetite — and a man whose two obsessions, the water and the seeds, both become plot instruments before the book is done.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Introduction (the worse one)', title: 'Mr Pendanski uses their real names', note: 'The friendly counselor: calls the boys by the names their mothers gave them, asks about their futures, encourages them to plan. The cruelty is reserved, precisely, for Zero — and it is this counselor, not the obvious brute, who detonates the second half.', min: 0.6 },
      { lane: '1', type: 'beat', beatFn: 'Establishing (the social system)', title: 'Group D, and the nicknames', note: 'X-Ray, Armpit, Squid, Magnet, Zigzag, Zero — and Stanley becomes Caveman. The camp runs on nicknames, which is characterization and also concealment: the book can hide a Zeroni in plain sight for forty chapters behind a name that means nobody.', min: 0.6 },
      { lane: '1', type: 'beat', beatFn: 'Plant (the silent one)', title: 'Zero never says anything', note: 'The smallest boy in the tent doesn\'t talk, doesn\'t react, and is assumed by everyone — boys and counselors alike — to be stupid. He is also the fastest digger in Group D. The book states both facts early and lets the reader draw the inference the camp never does.', min: 0.4 },

      // ===== LANE 1 — CHAPTER 7 · LATVIA (flashback, ~150 years) =====
      { lane: '1', type: 'scene', title: 'Chapter 7 · Latvia, 150 Years Ago — Elya and Madame Zeroni', words: 1300 },
      { lane: '1', type: 'beat', beatFn: 'Flashback opens (strand 3)', title: 'Elya Yelnats wants Myra Menke', note: 'The first jump backward, dropped in while Stanley digs his first hole: a fifteen-year-old in Latvia in love with a girl whose father will award her to whoever brings the fattest pig. The novel establishes its method here — a past chapter arrives with no framing and no explanation of relevance.', min: 0.3 },
      { lane: '1', type: 'beat', beatFn: 'PLANT (the bargain) — the whole book', title: 'Carry the pig up the mountain, and sing to it', note: 'Madame Zeroni\'s terms, which are also the novel\'s blueprint: take the piglet up the mountain every day to drink from the stream, sing to it while it drinks, and when it is full grown carry *her* up to drink, and sing to her too. Everything in the last third of the book is this instruction, executed by the wrong people a century and a half late.', min: 0.6 },
      { lane: '1', type: 'beat', beatFn: 'The debt incurred', title: 'He sails without carrying her', note: 'Elya wins the pig contest into a tie, realizes Myra is not worth having, and leaves for America — forgetting the second half of the bargain entirely. Madame Zeroni curses him and his descendants. The book\'s first cause is an act of thoughtlessness, not malice, which is why it takes five generations and a stranger to settle.', min: 0.4 },

      // ===== LANE 1 — CHAPTERS 8–13 · THE FIRST HOLES =====
      { lane: '1', type: 'scene', title: 'Chapters 8–13 · Group D, and the First Holes', words: 5700 },
      { lane: '1', type: 'beat', beatFn: 'PLANT (the menace)', title: 'Eleven yellow spots', note: 'A full chapter of natural history on the yellow-spotted lizard — the spots, the black teeth, the white tongue, the fact that there is no antidote and that death is not quick. Delivered as an encyclopedia entry, thirty chapters before a lizard matters. The gun is not just on the mantelpiece; it is labelled.', min: 0.6 },
      { lane: '1', type: 'beat', beatFn: 'The body', title: 'The first hole takes all day', note: 'Blisters, then broken blisters, then a hole that takes from before dawn until afternoon. Sachar spends real page count on the physical fact of digging so the reader feels the labour the camp is stealing — the exploitation lands as sensation before it lands as information.', min: 0.9 },
      { lane: '1', type: 'beat', beatFn: 'Ritual', title: 'Spit in the hole', note: 'The custom for a finished hole: spit in it and walk away. A throwaway detail that gives the digging a culture, and gives the boys one gesture of ownership over work that is entirely taken from them.', min: 0.4 },
      { lane: '1', type: 'beat', beatFn: 'Economy', title: 'Four minutes of shower', note: 'The camp\'s whole economy in a list: a short cold shower, two sets of clothes washed on rotation, and a canteen filled on the counselor\'s schedule. Scarcity as administration rather than cruelty, which is what makes X-Ray\'s control of the water line worth having.', min: 0.4 },
      { lane: '1', type: 'beat', beatFn: 'How bad it is', title: 'Barf Bag steps on a rattlesnake', note: 'A camper deliberately puts his foot next to a rattlesnake to get airlifted out. Reported almost in passing, and it is the most efficient statement of the stakes in the book: the desert is preferable to the camp, and everybody has already done that arithmetic.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Plant (competence)', title: 'Zero finishes first, every day', note: 'The smallest, youngest, supposedly stupidest boy digs the fastest hole in Group D and then sits in the sun waiting. Nobody draws a conclusion from it. The novel places its most obvious clue about Zero in the one place the camp will never look — his work.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'The wrong find', title: 'A fish fossil in a dry lake', note: 'Stanley digs up a fossilized fish and is thrilled; the counselors are indifferent, because it is not what they are looking for. The scene teaches the reader to ask the right question — not "what is buried here" but "what are *they* hoping for" — and quietly confirms the lake was once real.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Hierarchy', title: 'X-Ray drinks first', note: 'X-Ray is small and half-blind but runs Group D through the water order and the rule that any find gets handed to him. The camp\'s official power is Mr Sir\'s; the operative power is a boy\'s, and Stanley\'s first real decision is whether to buy into it.', min: 0.5 },
      { lane: '1', type: 'beat', beatFn: 'Plant (literacy)', title: 'Letters to his mother', note: 'Stanley writes home pretending camp is a summer adventure — and takes care that the other boys don\'t see him doing it. Reading and writing established as a private, slightly shameful skill in this yard, which is what makes the trade in chapter 22 possible.', min: 0.4 },
      { lane: '1', type: 'beat', beatFn: 'THE FIND', title: 'A gold tube stamped KB', note: 'Stanley digs up a small gold cylinder with a heart and the initials KB — and hands it to X-Ray to claim, buying a place in the group with the most important object in the book. Two initials the reader cannot decode for another ten chapters; the plot turns on a piece of litter.', min: 1.0 },

      // ===== LANE 2A — CHAPTERS 14–22 · THE WARDEN =====
      { lane: '2A', type: 'scene', title: 'Chapters 14–22 · X-Ray\'s Find, and the Warden', words: 7900 },
      { lane: '2A', type: 'beat', beatFn: 'The lie holds', title: 'X-Ray finds it the next morning', note: 'X-Ray produces the tube on his own patch a day later and gets the day off. Stanley says nothing. A small corruption, cheerfully performed — and the delay is what lets the Warden misplace her entire search grid by one hole.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'Reveal (the real antagonist)', title: 'The Warden comes out for it', note: 'She arrives within minutes of the find, which no ordinary discovery would justify. Red hair, soft voice, and total authority over the men who terrify the boys. The book has spent thirteen chapters implying the camp is pointless cruelty; her interest is the first evidence it is a *plan*.', min: 0.8 },
      { lane: '2A', type: 'beat', beatFn: 'Violence (the register set)', title: 'Rattlesnake venom in the nail polish', note: 'When Mr Sir questions her, she scratches him across the face with polish cut with venom — not fatal, but disfiguring and agonizing, and delivered as a correction rather than a rage. The camp\'s real danger is established in one gesture, and it is not the desert.', min: 0.8 },
      { lane: '2A', type: 'beat', beatFn: 'Reveal (the search grid)', title: 'Dig where the tube was', note: 'The whole crew is redirected to the area around X-Ray\'s hole and told to report anything unusual. The digging finally makes sense: a hundred boys are a free excavation crew, and the holes are a search pattern. The premise inverts — this was never a punishment, it was a workforce.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'Image (the only shade)', title: 'Two trees and a hammock', note: 'The Warden\'s cabin sits under the only two trees on the property, with a hammock strung between them. A hundred boys in full sun and one woman in the shade — the camp\'s politics rendered as a single stage picture, established in chapter one and paid off every time she walks out of it.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'The body changes', title: 'He stops being the fat kid', note: 'Weeks of digging and Stanley is harder, faster, finishing earlier. The transformation the camp\'s slogan promised is actually happening — physically, and by accident — while the moral version it advertised is nowhere in sight.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'Pressure', title: 'Stanley takes the blame for the seeds', note: 'Magnet steals Mr Sir\'s sunflower seeds, the sack goes over, and Stanley claims it — earning a session in the Warden\'s cabin and learning that she is worse than anything the desert has. His first act of loyalty, and it is spent on people who wouldn\'t spend it on him.', min: 0.8 },
      { lane: '2A', type: 'beat', beatFn: 'Petty cruelty', title: 'Mr Sir stops filling his canteen', note: 'The counselor takes his revenge in the one currency that matters, pouring Stanley\'s water into the dirt at each break. Survival reduced to a man\'s mood — and the reason Stanley will later think of the truck.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'THE TRADE', title: 'Zero digs, Stanley teaches', note: 'Zero offers to dig part of Stanley\'s hole in exchange for reading lessons. Stanley hesitates — the tent will read it as buying a servant — and accepts. The novel\'s central relationship begins as a labour contract between two boys with nothing, and it is the only fair exchange in the book.', min: 1.0 },
      { lane: '2A', type: 'beat', beatFn: 'THE NAME', title: 'Zero is Hector Zeroni', note: 'Asked, for the reading lesson, what his name is: Hector Zeroni. Dropped without emphasis into the middle of a spelling exercise. The reader who remembers chapter 7 solves the entire book here, twenty chapters before the characters do — Sachar\'s braid paying off in the reader\'s head first.', min: 0.7 },
      { lane: '2A', type: 'beat', beatFn: 'Resentment', title: 'The tent turns on it', note: 'Group D reads the arrangement as Stanley making Zero his slave and Zero making Stanley soft; X-Ray\'s authority is threatened by a deal he didn\'t broker. The one decent transaction in the camp is the one everybody objects to.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'Violence (the tent)', title: 'Zigzag swings on him', note: 'The resentment turns physical — Zigzag picks the fight, the group circles, and the counselors watch it happen. The camp\'s adults intervene only to protect the digging, never the boys, and the scene makes explicit that Group D is not a support system.', min: 0.5 },

      // ===== LANE 2A — CHAPTERS 23–26 · GREEN LAKE 1888 (flashback) =====
      { lane: '2A', type: 'scene', title: 'Chapters 23–26 · Green Lake, 110 Years Ago — Katherine and Sam', words: 3300 },
      { lane: '2A', type: 'beat', beatFn: 'Flashback opens (strand 2)', title: 'The town when there was water', note: 'Green Lake as it was: the largest lake in Texas, a real town, peach trees, and a schoolteacher whose spiced peaches are famous for miles. The dead lakebed the boys dig in is shown alive, which retroactively makes the present-day setting a crime scene.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'Introduction', title: 'Sam, and the onion boat', note: 'Sam rows across the lake with his donkey Mary Lou, sells onions as a cure for everything, and can repair anything anyone brings him. Four details — the boat, the donkey, the onions, the fixing — and every one of them is load-bearing in Part Two.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'The transaction that becomes love', title: 'Fixing the schoolhouse roof, one jar at a time', note: 'Katherine trades preserves for repairs; the repairs take longer than they need to. A courtship conducted entirely in maintenance work, and the warmest passage in a book about a labour camp.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'The rival', title: 'Trout Walker wants her', note: 'The richest man in town, who does not swim well and smells of fish, expects to be accepted and is refused — first for himself, and then in favour of a Black onion farmer, which he takes as the greater insult.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'THE CRIME', title: 'The kiss, the mob, and the schoolhouse burning', note: 'They are seen kissing; the town burns the schoolhouse, the sheriff — drunk — offers Katherine protection in exchange for a kiss and tells her that a Black man kissing a white woman will hang. She and Sam run for the boat.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'THE MURDER (and the drought)', title: 'Sam is shot on the water', note: 'They are intercepted mid-lake; Sam is killed, Mary Lou too. And then the sentence the whole novel is organized around: it has not rained on Green Lake since. The setting\'s central fact — a hundred boys digging in a dry lakebed — is revealed as an unpunished murder, still visible from space.', min: 0.6 },

      // ===== LANE 2A — CHAPTERS 27–28 · THE BRAID TIGHTENS =====
      { lane: '2A', type: 'scene', title: 'Chapters 27–28 · Kissin\' Kate, and the End of Part One', words: 2000 },
      { lane: '2A', type: 'beat', beatFn: 'Transformation', title: 'The schoolteacher becomes the outlaw', note: 'Katherine shoots the sheriff, paints her lips, and spends twenty years robbing across the West, kissing the men she kills. Grief converted directly into a career — and the lipstick tube from chapter 13 is now identified, retroactively, as hers.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'PLANT (the suitcase)', title: 'She robs Stanley Yelnats I', note: 'Among her victims: Stanley\'s great-grandfather, carrying his fortune east, left stranded in the desert. He survives by finding refuge on what he later calls God\'s Thumb. Two plants in one paragraph — the buried suitcase, and the instructions for surviving the desert.', min: 0.5 },
      { lane: '2A', type: 'beat', beatFn: 'The refusal', title: 'Kate Barlow lets the lizard bite her', note: 'Trout Walker and his wife find her twenty years later and demand the treasure; she refuses, laughing, and dies of a lizard bite rather than tell them — leaving them, she says, to dig for a hundred years and find nothing. The Warden\'s entire life\'s work is set in motion by a woman\'s last joke.', min: 0.6 },
      { lane: '2A', type: 'beat', beatFn: 'Part One ends', title: 'Everything is now loaded', note: 'Sachar closes his first part with all three timelines delivered and every device planted: a curse, a bargain about carrying someone uphill, an onion field, a rowboat, jars of peaches, a lipstick tube, a stolen suitcase, God\'s Thumb, and the lizards. Nothing has been paid off yet. The reader can see the shape and the characters cannot.', min: 0.4 },

      // ===== LANE 2B — CHAPTERS 29–34 · ZERO RUNS =====
      { lane: '2B', type: 'scene', title: 'Chapters 29–34 · Zero Runs, and Stanley Follows', words: 5600 },
      { lane: '2B', type: 'beat', beatFn: 'Provocation', title: 'Pendanski humiliates Zero over the reading', note: 'The counselor makes Zero the object lesson — that some people are simply too stupid to teach — in front of the whole group. The one adult who performs kindness is the one who inflicts the wound, and the book has been setting up the distinction since chapter 4.', min: 0.7 },
      { lane: '2B', type: 'beat', beatFn: 'BREAK (the turn)', title: 'Zero swings the shovel and walks into the desert', note: 'Zero hits Pendanski with his shovel and leaves — not running, walking, out into a hundred miles of nothing. The camp story becomes a survival story in one gesture, and the Warden\'s response is the tell: she has his records destroyed, because a boy nobody can prove existed cannot be reported missing.', min: 0.8 },
      { lane: '2B', type: 'beat', beatFn: 'Complicity', title: 'The Warden erases him', note: 'The files go into the shredder. It is the coldest moment in the novel and it is done administratively — no violence, just paperwork — and it is also, precisely, what makes Zero\'s release possible at the end. The villain\'s cruelty and her undoing are the same act.', min: 0.7 },
      { lane: '2B', type: 'beat', beatFn: 'Failure of nerve', title: 'Stanley does nothing, for a day', note: 'A new boy takes Zero\'s cot; the digging goes on. Sachar makes Stanley wait — and makes the reader wait with him — so that the decision, when it comes, is a choice rather than a reflex.', min: 0.5 },
      { lane: '2B', type: 'beat', beatFn: 'Replacement', title: 'Twitch takes the cot', note: 'A new camper arrives, is given a nickname within the hour, and slots into the gap as though there had never been anyone there. The nickname system that hid Hector Zeroni now disposes of him — the machine closing over the space where a boy was.', min: 0.5 },
      { lane: '2B', type: 'beat', beatFn: 'Geography as antagonist', title: 'A hundred miles of nothing', note: 'The scale of the escape stated plainly: no road, no water, no shade, and a boy already a day and a half ahead on foot. The novel spends real page count on the emptiness so the reader understands that following Zero is not a rescue plan, it is a decision to die with him.', min: 0.7 },
      { lane: '2B', type: 'beat', beatFn: 'The decision', title: 'He takes the water truck', note: 'Stanley steals Mr Sir\'s truck to go after him, and immediately drives it into a hole — the camp\'s own excavation defeating the escape. He runs on foot with no water, which is the worst possible version of the plan and the only one available.', min: 0.8 },
      { lane: '2B', type: 'beat', beatFn: 'PAYOFF (the boat)', title: 'Mary Lou, upside down in the dirt', note: 'Stanley finds Zero half-dead under the hull of a rotted rowboat with the name Mary Lou on it — Sam\'s boat, from a lake that dried up a century ago, sheltering the descendant of the woman who cursed his family. The braid\'s first physical convergence: two timelines touching one object.', min: 0.9 },

      // ===== LANE 2B — CHAPTERS 35–38 · THE SPLOOSH AND THE THUMB =====
      { lane: '2B', type: 'scene', title: 'Chapters 35–38 · The Sploosh, and Big Thumb', words: 3800 },
      { lane: '2B', type: 'beat', beatFn: 'PAYOFF (the peaches)', title: 'Sixteen jars under the boat', note: 'Zero has been living on what he calls sploosh — jars of preserved peaches buried with the boat. Kate Barlow\'s famous spiced peaches, a hundred and ten years old, are the only food two starving boys have. A love token from one timeline becomes rations in another.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'The target', title: 'The thumb-shaped rock on the horizon', note: 'Stanley fixes on a formation shaped like a fist with a thumb — the shape his great-grandfather described after being robbed. He is navigating by a hundred-year-old family anecdote, which is the only map anyone in this book has ever had.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'Collapse', title: 'Zero can\'t walk', note: 'The sploosh runs out and Zero, weaker and sicker, stops being able to keep up, then stops being able to stand. The novel arranges, with total deliberateness, the exact situation of Madame Zeroni\'s bargain: one person who must be carried up a mountain by another.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'THE PAYOFF — the debt settled', title: 'Stanley carries him up the mountain', note: 'He carries Zero up the slope on his back, and to keep going he sings — the family lullaby, the one Elya learned from Madame Zeroni and passed down. The bargain of chapter 7 executed to the letter, a century and a half late, by a boy who does not know he is doing it: carry a Zeroni up the mountain, to water, and sing.', min: 0.8 },
      { lane: '2B', type: 'beat', beatFn: 'PAYOFF (water, and onions)', title: 'Mud, then a stream, then an onion field', note: 'At the top: water in the mud, then a spring, and a whole hillside of wild onions — Sam\'s field, still growing where the rain still falls. The two boys eat nothing but onions for days. The murdered man\'s crop keeps them alive, and the novel has not said a word about coincidence.', min: 0.7 },
      { lane: '2B', type: 'beat', beatFn: 'The curse lifts (unremarked)', title: 'Nothing dramatic happens', note: 'No thunderclap, no sign. Sachar refuses to mark the moment — the reader is left to notice, later and on their own, that the family\'s luck turns from here. The most important event in a hundred and fifty years is delivered as two boys resting on a hill.', min: 0.5 },

      // ===== LANE 2B — CHAPTERS 39–42 · GOD'S THUMB =====
      { lane: '2B', type: 'scene', title: 'Chapters 39–42 · God\'s Thumb, and the Confession', words: 3900 },
      { lane: '2B', type: 'beat', beatFn: 'Recovery', title: 'Days on the thumb', note: 'They dig for water, eat onions, and heal — the first time in the book either boy has been neither watched nor worked. The novel gives its two protagonists a genuine idyll before the last movement, which is what makes the decision to go back cost something.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'PAYOFF (the lessons)', title: 'The reading lessons start again', note: 'On the hillside, with nothing to do but heal, Zero learns to read properly. The transaction that began as payment for digging continues with nothing left to trade — the first thing in the book either boy does purely because they want to.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'Backstory (the lullaby)', title: 'What Zero remembers of his mother', note: 'Fragments: a park, a yellow room, being told to wait, and a song. He does not know he is describing the other half of Stanley\'s family inheritance — the reader assembles it, again, several chapters ahead of the characters.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'THE CONFESSION', title: 'Zero stole the shoes', note: 'Zero admits it: homeless, he took the sneakers from the shelter display, then panicked and left them on a parked car — which drove under an overpass, from which they fell onto Stanley. The wrongful conviction of chapter 2 is explained from the other end, and it turns out the two boys were connected before either had heard of Camp Green Lake.', min: 0.8 },
      { lane: '2B', type: 'beat', beatFn: 'The reframe', title: 'Neither of them was ever the criminal', note: 'The confession does not divide them; Stanley works out that Zero\'s theft, his own conviction, and their meeting are one chain of events. The book\'s moral arithmetic: the boy the state calls guilty stole a pair of shoes because nobody fed him.', min: 0.6 },
      { lane: '2B', type: 'beat', beatFn: 'The turn back', title: 'They decide to go and dig it up', note: 'Stanley works out that the tube marked KB, the Warden\'s search grid, and his great-grandfather\'s robbery are the same story, and that whatever is buried belongs to his family. The runaways choose to walk back into the prison — not to escape, but to finish the dig on their own terms.', min: 0.7 },

      // ===== LANE 3 — CHAPTERS 43–47 · THE LAST HOLE =====
      { lane: '3', type: 'scene', title: 'Chapters 43–47 · The Last Hole', words: 4900 },
      { lane: '3', type: 'beat', beatFn: 'Return', title: 'Back over the wall with a sack of onions', note: 'They fill a sack with onions and walk back into camp at night — a detail played as provisions, which is the last time the book will let the reader take an onion at face value.', min: 0.5 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the misplaced grid)', title: 'Digging where Stanley actually found it', note: 'They dig in the spot Stanley found the tube — not X-Ray\'s spot, where the Warden has been searching for a year. Chapter 14\'s small dishonesty is what has kept the treasure buried, and the boy who gave the credit away is the only one who knows where the hole should be.', min: 0.6 },
      { lane: '3', type: 'beat', beatFn: 'THE FIND', title: 'A suitcase with his own name on it', note: 'The metal-edged case comes up bearing Stanley Yelnats — his great-grandfather\'s, robbed by Kate Barlow, buried under a lake that would dry up. The name that has been a family joke since chapter 3, stamped on the object at the bottom of the hole.', min: 0.8 },
      { lane: '3', type: 'beat', beatFn: 'The trap', title: 'The Warden is standing at the rim', note: 'Flashlights: the Warden, Mr Sir and Mr Pendanski at the edge of the hole, waiting for the boys to hand it up. The dig is finished and the boys are still in a five-foot hole in the dark, holding two million dollars.', min: 0.5 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the menace, at last)', title: 'The hole is full of lizards', note: 'The adults can\'t come down and the boys can\'t come up: the hole is crawling with yellow-spotted lizards, the ones catalogued in chapter 8. A standoff in which the villains are prevented from taking the treasure by the very thing they warned the boys about — and the lizards crawl over the two of them without biting.', min: 0.8 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the onions)', title: 'They don\'t like onion blood', note: 'The reason is the onions — days of eating nothing else. Sam\'s cure-all, from the murdered onion man of a hundred and ten years ago, is what makes two boys inedible. The book\'s most audacious payoff, and it was planted as a folksy character detail in a flashback.', min: 0.5 },
      { lane: '3', type: 'beat', beatFn: 'The long night', title: 'They wait for the boys to die', note: 'The adults settle in at the rim to wait out the lizards, and the Warden talks — about her childhood, about being made to dig this lakebed every weekend of it, about a family that has spent three generations on a hole. The villain\'s motive delivered while her victims stand in a pit beneath her, too tired to be frightened.', min: 0.6 },
      { lane: '3', type: 'beat', beatFn: 'Rescue (the mundane kind)', title: 'A lawyer arrives at dawn', note: 'Stanley\'s conviction has been overturned and a lawyer with the Attorney General has come to collect him — the standoff broken not by heroics but by paperwork arriving on schedule. Sachar deflates his own climax on purpose: the desert had rules, the law has procedure, and the boys survive both.', min: 0.6 },

      // ===== LANE 3 — CHAPTERS 48–50 · FILLING IN THE HOLES =====
      { lane: '3', type: 'scene', title: 'Chapters 48–50 · Filling in the Holes', words: 3500 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the erased boy)', title: 'They can\'t find Hector\'s records', note: 'Stanley refuses to leave without Zero; the Warden\'s office cannot produce a file, because she destroyed it. Her own coldest act is what frees him — the shredder in chapter 30 turning, without a word of comment, into the thing that saves the boy it was meant to erase.', min: 0.6 },
      { lane: '3', type: 'beat', beatFn: 'The suitcase opened', title: 'Deeds, stock certificates, and a name', note: 'The case holds papers worth close to two million dollars, and the claim is unarguable because the name on it is Stanley\'s. The boys split it. A treasure hunt resolved by documentation rather than adventure, which is the same joke as the lawyer.', min: 0.5 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the drought)', title: 'It starts to rain on the lake', note: 'Camp Green Lake closes, and rain falls on the dry lakebed for the first time in a hundred and ten years. The murder in chapter 26 is finally answered — not by justice for Sam, which the book never offers, but by weather. The landscape has been holding a grudge and it lets go.', min: 0.5 },
      { lane: '3', type: 'beat', beatFn: 'PAYOFF (the invention)', title: 'Stanley\'s father cures foot odour', note: 'The failing inventor succeeds the day after the curse breaks, with a product that smells of peaches — and the pitchman is Clyde Livingston, whose shoes started the whole thing, and whose feet have the same complaint Trout Walker had. Three timelines meeting in a television commercial.', min: 0.6 },
      { lane: '3', type: 'beat', beatFn: 'CODA — the last payoff', title: 'A woman sings the second verse', note: 'The final scene, a year and a half on: Hector, found by the investigators he hired, sits with his mother as she sings the lullaby — and it is the Yelnats family song, with a verse the Yelnats never had. The two families\' shared inheritance, whole again in the last paragraph, and the book stops without explaining it.', min: 0.8 },
      { lane: '3', type: 'beat', beatFn: 'Structure note', title: 'Filling in the holes', note: 'Sachar titles his third part after what it does: every remaining gap is closed in ten pages, and none of it is exposition — each answer arrives as a scene. The braid\'s final property is that the reader has been assembling this for two hundred pages, so the ending feels less like a reveal than a confirmation.', min: 0.5 },
    ],
  },
};
